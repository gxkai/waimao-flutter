...
class ArealDistributionModel extends ViewStateRefreshPlainModel {
  String _fromDate;
  String _toDate;
  num _index = 0;
  List<VisitByCountryInfo> _list = [];
  List<VisitByCountryInfo> get items => _list;
  String get fromDate => _fromDate;
  String get toDate => _toDate;
  num get index => _index;
  ArealDistributionModel(this._fromDate, this._toDate);
  Future loadData() async {
    _list = await DataUtils.visitByCountry({fromDate: _fromDate, toDate: toDate});
  }
